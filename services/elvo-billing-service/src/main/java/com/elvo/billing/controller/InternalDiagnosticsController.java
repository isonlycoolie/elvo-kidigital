...
public class InternalDiagnosticsController {
    ...
    public InternalDiagnosticsController(
            SentryExceptionMapper sentryExceptionMapper,
    ...
    public ResponseEntity<Map<String, Object>> sentryProbe(
        ...
        sentryExceptionMapper.capture(new IllegalStateException("billing_sentry_runtime_probe"), "SENTRY_RUNTIME_PROBE");

        Map<String, Object> response = new LinkedHashMap<>();
        response.put("status", "captured");
        response.put("service", "billing");
