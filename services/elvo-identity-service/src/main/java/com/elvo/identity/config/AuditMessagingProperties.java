...
@ConfigurationProperties(prefix = "elvo.messaging.audit")
public class AuditMessagingProperties {

    private String eventVersion = "v1";
    private String exchange = "elvo.identity.audit.exchange";
    private String routingKey = "elvo.identity.audit.event";
    private String deadLetterExchange = "elvo.identity.audit.dlx";
    private String deadLetterRoutingKey = "elvo.identity.audit.dead";
    private String queue = "elvo.identity.audit.queue";
    private String deadLetterQueue = "elvo.identity.audit.dlq";
    private String retryQueue = "elvo.identity.audit.retry.queue";
    private String retryRoutingKey = "elvo.identity.audit.retry";
