...
@Component
@ConfigurationProperties(prefix = "elvo.clients.account-management")
public class AccountClientProperties {

    private String baseUrl = "https://localhost:8384/api/v1/internal/accounts";
    ...
    public void setBaseUrl(String baseUrl) {
        if (baseUrl != null && !baseUrl.trim().isEmpty() && baseUrl.trim().startsWith("http://")) {
            throw new IllegalArgumentException("Account service baseUrl must use HTTPS protocol. Received: " + baseUrl);
        }
