...
public class InternalDiagnosticsController {
    ...
    public ResponseEntity<Map<String, Object>> sentryProbe(
        ...
        IllegalStateException probeException = new IllegalStateException("wallet_sentry_runtime_probe");
        sentryExceptionReporter.captureCriticalException(
                probeException,
                request,
                Map.of("probe", "runtime-wiring", "service", "wallet"));

        Map<String, Object> response = new LinkedHashMap<>();
        response.put("status", "captured");
        response.put("service", "wallet");
